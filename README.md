...
- [Technologies Used](#technologies-used)
    - [Backend (book-social-network)](#backend-book-network)
...
![Security diagram](diagrams/images/security.png)

#### Backend pipeline
![Security diagram](diagrams/images/be-pipeline.png)

#### Backend pipeline
![Security diagram](diagrams/images/fe-pipeline.png)
